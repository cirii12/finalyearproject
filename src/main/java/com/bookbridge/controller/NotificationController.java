...
public class NotificationController {
    ...
    public ResponseEntity<?> getUserNotifications(
        ...
        try {
            ...
            Page<Notification> notificationsPage = notificationService.getUserNotificationsPaged(userOpt.get(),
                    pageable);
    ...
    public ResponseEntity<?> clearAllNotifications() {
        try {
            ...
            notificationService.deleteAllNotifications(userOpt.get());
            return ResponseEntity.ok(Map.of("message", "All notifications cleared"));

        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(Map.of("message", "Error clearing notifications: " + e.getMessage()));
        }
    }
}