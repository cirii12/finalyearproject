...
public class PDFService {
    ...
    private void addExecutiveSummary(Document document) throws Exception {
        ...
        addSummaryRow(summaryTable, "Monthly Active Users",
                String.valueOf(userService.countUsersCreatedAfter(startOfMonth)));
        addSummaryRow(summaryTable, "Books Listed This Month",
                String.valueOf(bookService.countBooksCreatedAfter(startOfMonth)));
    ...
    private void addRevenueAnalytics(Document document) throws Exception {
        ...
        addSummaryRow(revenueTable, "Monthly Revenue (Rs.)",
                String.valueOf(monthlyRevenue != null ? monthlyRevenue : 0));
        addSummaryRow(revenueTable, "Payment Revenue (Rs.)",
                String.valueOf(paymentRevenue != null ? paymentRevenue : 0));
    ...
    private void addTextBasedCharts(Document document) throws Exception {
        ...
        Paragraph orderChart = new Paragraph("Order Status Distribution:",
        ...
        Paragraph bookChart = new Paragraph("Book Status Distribution:",
                FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12));
    ...
    private void addAnalyticsFooter(Document document) throws Exception {
        ...
        footer.add(new Chunk("Generated on: "
    ...
    private void addTotal(Document document, Order order) throws Exception {
        ...
        Paragraph costBreakdown = new Paragraph();
        costBreakdown.setAlignment(Element.ALIGN_RIGHT);
        ...
        costBreakdown.add(new Chunk("Subtotal: Rs. " + subtotal + "/-\n", normalFont));
        costBreakdown.add(new Chunk("Delivery Charge: Rs. " + deliveryCharge + "/-\n", normalFont));
        ...
        costBreakdown.add(new Chunk("\nTotal Amount: Rs. " + order.getTotalAmount() + "/-", headerFont));
        costBreakdown.setSpacingAfter(20);
